        ...
        window.switchPage = function(pageId) {
            ...
            // صفحة إضافة مصروف بقت جزء من تاب الحسابات، فلما تكون مفتوحة نفعّل نفس التاب في الشريط السفلي
            const navHighlightId = (pageId === 'page-add') ? 'page-accounts' : pageId;
            document.querySelectorAll('.tab-btn').forEach(btn => {
                btn.classList.toggle('active', btn.dataset.page === navHighlightId);
            });
            document.querySelectorAll('.accounts-subtab-btn').forEach(btn => {
